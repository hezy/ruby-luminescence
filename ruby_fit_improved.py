...
for file in sorted(files):
    ...
    #             label='peak 2')
    plt.plot(x, ydif, linestyle="-", alpha=0.7, linewidth=2, label="residual")
    ...
    plt.figtext(0.15, 0.90, file, ha="left", va="center")
